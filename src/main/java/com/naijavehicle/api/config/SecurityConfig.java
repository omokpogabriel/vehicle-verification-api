...
import com.naijavehicle.api.security.RequestLoggingFilter;
...
public class SecurityConfig {
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http,
                                                        ...
                                                        com.naijavehicle.api.security.CustomUserDetailsService userDetailsService) throws Exception {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/api/v1/verify/plate/*").permitAll()
                ...
                .addFilterBefore(requestLoggingFilter, HeaderValidationFilter.class);
